...
CREATE TABLE `projects` (
  ...
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `remoteurl` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `remoteproject` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `repositories` (
  ...
  `db_project_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `remote_project_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rebuild` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `block` varchar(5) COLLATE utf8_unicode_ci DEFAULT NULL,
  `linkedbuild` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `realname` varchar(200) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `password` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `password_hash_type` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `password_salt` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT '1234512345',
  `password_crypted` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
